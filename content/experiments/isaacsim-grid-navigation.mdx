...
![Quadrupeds stepping across a grid with red and blue footprint markers](/images/isaacsim-grid-navigation.png)

<Callout type="note" title="Image placement">
  Save the provided screenshot at <code>public/images/isaacsim-grid-navigation.png</code> to render the hero image.
</Callout>

## Local run video

<VideoEmbed src="/videos/Screen%20Recording%202025-12-15%20174554.mp4" title="Warehouse navigation capture" />
